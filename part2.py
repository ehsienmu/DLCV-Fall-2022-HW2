...
def train_mnist():
    ...
    lrate = 1e-4
    save_model = False
    save_dir = './part2_save_dir/diffusion/'
    ckpt_save_dir = './part2_save_dir/diffusion/ckpt'
    imgs_save_dir = './part2_save_dir/diffusion/imgs'
    gifs_save_dir = './part2_save_dir/diffusion/gifs'
    ...
    # ddpm.load_state_dict(torch.load("./part2_save_dir/data/diffusion_outputs/ddpm_unet01_mnist_9.pth"))
    ...
    for ep in range(n_epoch):
        ...
        with torch.no_grad():
            ...
            for w_i, w in enumerate(ws_test):
                ...
                save_image(grid, imgs_save_dir + f"image_ep{ep}_w{w}.png")
                print('saved image at ' + imgs_save_dir + f"image_ep{ep}_w{w}.png")
        ...
        torch.save(ddpm.state_dict(), ckpt_save_dir + f"model_{ep}.pth")
        print('saved model at ' + ckpt_save_dir + f"model_{ep}.pth")
